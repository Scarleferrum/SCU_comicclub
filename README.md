This project, `Soochow University Comic Club Website` originally made for Soochow University Comic Club(short written as SCUCC). This website is based on `html` and `css` with using `Github Pages`.
